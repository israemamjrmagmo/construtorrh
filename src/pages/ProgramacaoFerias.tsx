...
import { Search, Umbrella, CalendarDays, AlertTriangle, CheckCircle2, Clock, ChevronDown, ChevronUp } from 'lucide-react'
...
export default function ProgramacaoFerias() {
  ...
  const [faltas, setFaltas]   = useState<Record<string, string[]>>({})  // colabId → [data, data, ...]
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: 'var(--background)' }}>
      ...
      <div style={{ padding: '8px 20px', background: '#f8fafc', borderBottom: '1px solid var(--border)', display: 'flex', gap: 16, flexWrap: 'wrap' }}>
        ...
        <span style={{ fontSize: 11, color: '#64748b', marginLeft: 'auto' }}>
          Regra: ≤5 faltas=30d · 6-14=24d · 15-23=18d · 24-32=12d · +32=perde
        </span>
      </div>
